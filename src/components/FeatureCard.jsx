export default function FeatureCard({ icon, title, description, badge }) {
  return (
    <div className="card group hover:border-light-400 dark:hover:border-dark-700 
                     transition-all duration-300 hover:shadow-md dark:hover:shadow-none">
      <div className="flex items-start gap-4">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            <h3 className="font-semibold text-light-900 dark:text-white">{title}</h3>
